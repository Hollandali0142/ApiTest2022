    ...
    public void get02(){
        ...
        //String url=https://restful-booker.herokuapp.com/booking/10012;//onerilmez
           ...
           Response response =given().spec(spec).when().get("/{first}/{second}");
            ...
            //Beklenen data("Cowboy") test case den gelir, actual (gercekte olan(("Server"))) data API den gelir.
         //==>hata veriyor.   assertEquals("Cowboy", response.getHeaders("Server"));
