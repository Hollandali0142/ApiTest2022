 ...
 */
    ...
    public void getVeObjectMapper01(){
           ...
           //2. adem beklenen(expected) datayi set et
            //1. yol
             //  String beklenenData= "{\n" +
             //          "\"userId\": 10,\n" +
             //          "\"id\": 198,\n" +
           ...
           // System.out.println(beklenenDataMap);
            ...
            String beklenenDataMap2=data.beklenenDataStringFormati(10,"quis eius est sint explicabo", true);
            Map<String, Object> beklenenDataMap=JsonUtil.jsonJavayaCevir(beklenenDataMap2,HashMap.class);
            System.out.println(beklenenDataMap);

            //3. adim : request gonder, repanse al
