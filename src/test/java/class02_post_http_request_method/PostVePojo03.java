...
public class PostVePojo03 extends HerOkuAppBaseUrl {
   ...
   When
           ...
           URL Get request gonder (yeni olusturulan datayi almak icin)
   Then
   ...
   And
    ...
    public void test01(){
           ...
           // DataBase de yeni bir data olusturduktan sonra, eger "GET" veya baska bir method kullanmak istersek "bookingid" ye ihtiyac duyariz.
            // bookingId yeni olusturulan "POST" METHODUNDAN ALINIR.
           JsonPath json = response.jsonPath();
           Integer bookingId =json.getInt("bookingid");

           //ilk adim :GET methodu icin url i set et
