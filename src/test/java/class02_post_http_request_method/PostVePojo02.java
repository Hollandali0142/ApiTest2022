...
*/
        ...
        public void postVePojo02() {
            ...
            System.out.println(requestBody);
                //3. adim: request gonder , serponse al
            ...
            assertEquals(requestBody.getLastname(), actualData.getBooking().getFirstname());
            ...
            assertEquals(requestBody.getBookingdates().getCheckin(), actualData.getBooking().getBookingdates().getCheckout());
